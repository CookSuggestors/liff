...
function App() {
  ...
  const submitImage = () => {
    ...
    const imgUri = "https://hackathon-image-api.herokuapp.com/";
    axios
  ...
  return (
    <div className="App">
      ...
      <br />
      <img src={imageUrl} height="100" width="auto" alt="" />
      ...
      <div className="addIngredient">
        <input value={add} onChange={handleInputChange} />
        <button onClick={addIngredient}>追加</button>
      </div>

      <p>選んだ食材:{sendText}</p>
      <div className="form">
        <Button variant="contained" onClick={() => sendMessage(sendText)}>
          送信
        </Button>
      </div>
    </div>
